        ...
        return this.characterApi.getAll(3, 1, {title: e.value, hidden: 1}).then(
          (r) => {
            this.setState({
              ...
              friendsOptions: r.data
                .filter((el: Character) => {
                  return (
                    this.state.friends.findIndex(
            ...
            <Row>
              <Col md={6}>
                ...
                <Row>
                  <Col>
                    ...
                    <MyMultiSelect
                      id="friends"
                      label="Список друзей / знакомых персонажей"
                      placeholder="Введите всех друзей и знакомых данного персонажа..."
                      value={this.state.friends}
                      options={this.state.friendsOptions}
              ...
              <Col md={6}>
                ...
                <InputField
                  label="Игровое имя"
                  type="text"
                  placeholder="Введите игровое имя персонажа"
