...
import {defaultForumAvatar, Forum, User} from '../../../../../server/src/common/entity/types'
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                ...
                                <InputField id="title" label="Заголовок форума" placeholder="Введите название форума"
                                            type="text"
