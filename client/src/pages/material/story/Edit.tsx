...
import {Character, Guild, Story, storyStatusToString, User} from '../../../../../server/src/common/entity/types'
            ...
            <Page>
                <div className="page-edit">
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Row>
                            <Col md={6}>
                                <MyCropper label="Загрузите изображение сюжета" src={this.state.urlAvatar}
                                           ratio={260 / 190}
