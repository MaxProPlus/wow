                    ...
                    <div className="home__top">
                        ...
                        <div className="home__slider">
                            <div className="slider">
                                <div className="slider__list" style={{maxHeight: this.state.maxHeight}}>
                        ...
                        <div className="home__info">
                            <Widget className="widget_about" icon={aboutIcon}>О проекте</Widget>
                            <Widget className="widget_online" icon={onlineIcon}>Онлайн</Widget>
                            <Widget className="widget_vk" icon={vkIcon}>Мы в вк</Widget>
                        </div>
                    </div>
                </Page>
            </>
...
const Widget: React.FC<WidgetP> = ({className = '', icon, href = '#', children}: WidgetP) => {
    return (
        <Link to={href} className={`widget ${className}`}><img src={icon} alt=""/><span>{children}</span></Link>
    )
}
