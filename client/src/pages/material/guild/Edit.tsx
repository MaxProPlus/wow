          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Row>
              <Col md={6}>
                ...
                <Textarea
                  id="description"
                  label="Описание и история гильдии"
              ...
              <Col md={6}>
                ...
                <Select
                  id="status"
                  label="Статус"
                  placeholder="Выберите статус гильдии"
                  value={this.state.status}
                  onChange={this.handleChangeSelect}
                >
                  {[0, 1, 2].map((v) => (
                    <option key={v} value={v}>
                      {guildStatusToString(v)}
                    </option>
                  ))}
                </Select>
                <Select
