...
const CharacterList = React.lazy(
  () => import('../pages/material/character/List')
)
const CharacterCreate = React.lazy(
  () => import('../pages/material/character/Create')
)
const CharacterEdit = React.lazy(
  () => import('../pages/material/character/Edit')
)
const CharacterPage = React.lazy(
  () => import('../pages/material/character/Show')
)
...
const ListOfAdmins = React.lazy(
  () => import('../pages/admin/listOfAdmins/ListOfAdmins')
)
...
const TicketTypeList = React.lazy(
  () => import('../pages/help/ticket/list/TypeList')
)
...
const Registration = React.lazy(
  () => import('../pages/start/registration/Registration')
)
    ...
    <Suspense fallback={<Spinner />}>
      <Switch>
        ...
        <Route
          exact
          path="/article/create"
          render={(props) => <ArticleCreate {...props} scrollTop={scrollTop} />}
        />
        <Route
          path="/article/edit/:id"
          render={(props) => <ArticleEdit {...props} scrollTop={scrollTop} />}
        />
        <Route path="/article/:id" component={ArticlePage} />
        <Route exact path="/material/character" component={CharacterList} />
        <Route
          exact
          path="/material/character/create"
          render={(props) => (
            <CharacterCreate {...props} scrollTop={scrollTop} />
          )}
        />
        <Route
          path="/material/character/edit/:id"
          render={(props) => <CharacterEdit {...props} scrollTop={scrollTop} />}
        />
        <Route path="/material/character/:id" component={CharacterPage} />
        <Route exact path="/material/guild" component={GuildList} />
        <Route
          exact
          path="/material/guild/create"
          render={(props) => <GuildCreate {...props} scrollTop={scrollTop} />}
        />
        <Route
          path="/material/guild/edit/:id"
          render={(props) => <GuildEdit {...props} scrollTop={scrollTop} />}
        />
        <Route path="/material/guild/:id" component={GuildPage} />
        <Route exact path="/material/story" component={StoryList} />
        <Route
          exact
          path="/material/story/create"
          render={(props) => <StoryCreate {...props} scrollTop={scrollTop} />}
        />
        <Route
          path="/material/story/edit/:id"
          render={(props) => <StoryEdit {...props} scrollTop={scrollTop} />}
        />
        <Route path="/material/story/:id" component={StoryPage} />
        <Route exact path="/material/report" component={ReportList} />
        <Route
          exact
          path="/material/report/create"
          render={(props) => <ReportCreate {...props} scrollTop={scrollTop} />}
        />
        <Route
          path="/material/report/edit/:id"
          render={(props) => <ReportEdit {...props} scrollTop={scrollTop} />}
        />
        <Route path="/material/report/:id" component={ReportPage} />
        <Route exact path="/material/forum" component={ForumList} />
        <Route
          exact
          path="/material/forum/create"
          render={(props) => <ForumCreate {...props} scrollTop={scrollTop} />}
        />
        <Route
          path="/material/forum/edit/:id"
          render={(props) => <ForumEdit {...props} scrollTop={scrollTop} />}
        />
        ...
        <Route exact path="/help/ticket/type" component={TicketTypeList} />
        {/*категории тикетов*/}
        <Route path="/help/ticket/type/:id" component={TicketList} />{' '}
        {/*тикеты конкретной категории*/}
        <Route
          path="/help/ticket/create"
          render={(props) => <Create {...props} scrollTop={scrollTop} />}
        />
        {/*создание тикета*/}
        <Route path="/help/ticket/:id" component={TicketPage} />
        {/*конкретный тикет*/}
